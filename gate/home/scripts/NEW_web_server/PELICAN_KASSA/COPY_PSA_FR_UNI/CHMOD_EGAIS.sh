...
#        /usr/bin/sshpass -p $PASS ssh -o ConnectTimeout=2 -o StrictHostKeyChecking=no root@$ip "cat /home/1/.bashrc|grep './psa_fr_uni_copy.exe'||sed -i 's/.\/psa_fr_uni.exe \&/cp .\/psa_fr_uni_copy.exe .\/psa_fr_uni.exe\n.\/psa_fr_uni.exe \&/g' /home/1/.bashrc"  >> /dev/null 2>&1
        /usr/bin/sshpass -p $PASS ssh -o ConnectTimeout=2 -o StrictHostKeyChecking=no root@$ip "chmod 777 /home/1/drives/c/south.tml/common/EGAISPOS.CFG"  >> /dev/null 2>&1
