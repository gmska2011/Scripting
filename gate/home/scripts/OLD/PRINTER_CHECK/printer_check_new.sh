...
#	*Kyocera*) printer=`echo "Kyocera"`;;
    ...
    echo "INSERT INTO printers (id_object,id_ws,print_name) VALUES('$ID_MAG','$ID_WS','$printer');" | mysql $MYSQL; 
    echo "INSERT INTO printers (id_object,id_ws,print_name) VALUES('$ID_MAG','$ID_WS','$printer');"
