...
for ip in $IP_KASSA ; do
 sshpass -p $PASS scp -o 'StrictHostKeyChecking no' root@$ip:/home/1/drives/c/south.tml/POSTSTOP.PRG /home/scripts/copy_kass_south/tmp/  > /dev/null 2>&1
 if [ $? == 0 ] ; then
    echo $ip - OK
    sshpass -p $PASS scp /home/scripts/copy_kass_south/new/POSTSTOP.PRG root@$ip:/home/1/drives/c/south.tml/POSTSTOP.PRG  > /dev/null 2>&1

 else
    sshpass -p $PASS scp -o 'StrictHostKeyChecking no' root@$ip:/home/1/.dosemu/drives/c/south.tml/POSTSTOP.PRG /home/scripts/copy_kass_south/tmp/  > /dev/null
     if [ $? == 0 ] ; then
     echo $ip - OK
     sshpass -p $PASS scp /home/scripts/copy_kass_south/new/POSTSTOP.PRG root@$ip:/home/1/.dosemu/drives/c/south.tml/POSTSTOP.PRG  > /dev/null 2>&1
        ...
        sshpass -p $PASS scp -o 'StrictHostKeyChecking no' root@$ip:/home/1/.dosemu/drives/c/SOUTH.TML/POSTSTOP.PRG /home/scripts/copy_kass_south/tmp/  > /dev/nu
        if [ $? == 0 ] ; then
        echo $ip - OK
        sshpass -p $PASS scp /home/scripts/copy_kass_south/new/POSTSTOP.PRG root@$ip:/home/1/.dosemu/drives/c/SOUTH.TML/POSTSTOP.PRG  > /dev/null 2>&1
