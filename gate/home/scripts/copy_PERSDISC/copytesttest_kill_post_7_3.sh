...
users where name in ('П 7/3 кв','П 2 кв','П 2/3 кв','П 3/2 кв','П Ленина')" `
   echo $PARAM
   }
...
/usr/bin/sshpass -p $PASS ssh -o 'StrictHostKeyChecking no' root@$ip rm -r /home/1/drives/c/south.tml/POSTSTOP.PRG
/usr/bin/sshpass -p $PASS ssh -o 'StrictHostKeyChecking no' root@$ip rm -r /home/1/drives/c/south.tml/poststop.fxp
...
#echo TRYING $ip :
#echo 1
/usr/bin/sshpass -p $PASS scp -o 'StrictHostKeyChecking no' /home/scripts/copy_kass_south/new/POSTSTOP.PRG root@$ip:/home/1/drives/c/south.tml/POSTSTOP.PRG 
#echo 2
#/usr/bin/sshpass -p $PASS scp -o 'StrictHostKeyChecking no' /home/scripts/copy_kass_south/new/POSTSTOP.PRG root@$ip:/home/1/.dosemu/drives/c/south.tml/POSTSTOP.PRG
#echo 3
#/usr/bin/sshpass -p $PASS scp -o 'StrictHostKeyChecking no' /home/scripts/copy_kass_south/new/POSTSTOP.PRG root@$ip:/home/1/.dosemu/drives/c/SOUTH.TML/POSTSTOP.PRG
echo $ip - OK
