...
echo TRYING $ip :
echo 1
/usr/bin/sshpass -p $PASS scp -o 'StrictHostKeyChecking no' /home/scripts/copy_kass_south/obchepit/POSTSTOP.PRG root@$ip:/home/1/drives/c/south.tml/POSTSTOP.PRG 
echo 2
/usr/bin/sshpass -p $PASS scp -o 'StrictHostKeyChecking no' /home/scripts/copy_kass_south/obchepit/POSTSTOP.PRG root@$ip:/home/1/.dosemu/drives/c/south.tml/POSTSTOP.PRG
echo 3
/usr/bin/sshpass -p $PASS scp -o 'StrictHostKeyChecking no' /home/scripts/copy_kass_south/obchepit/POSTSTOP.PRG root@$ip:/home/1/.dosemu/drives/c/SOUTH.TML/POSTSTOP.PRG
