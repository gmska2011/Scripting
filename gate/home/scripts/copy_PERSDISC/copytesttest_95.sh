...
#PARAM=`mysql  -N -D ip_pelican -u root -puk.rjyfn2009 -e "SELECT ip_kassa_1,ip_kassa_2,ip_kassa_3,ip_kassa_4,ip_kassa_5,ip_kassa_6,ip_kassa_7,ip_kassa_8 FROM  users" `
  PARAM=`mysql  -N -D ip_pelican -u root -puk.rjyfn2009 -e "SELECT ip_kassa_1 FROM 
users where name = 'П 5/2 кв'" `
   echo $PARAM
   }
...
echo TRYING $ip :
echo 1
/usr/bin/sshpass -p $PASS scp /home/scripts/copy_kass_south/new/POSTSTOP.PRG root@$ip:/home/1/drives/c/south.tml/POSTSTOP.PRG 
echo 2
/usr/bin/sshpass -p $PASS scp /home/scripts/copy_kass_south/new/POSTSTOP.PRG root@$ip:/home/1/.dosemu/drives/c/south.tml/POSTSTOP.PRG
echo 3
/usr/bin/sshpass -p $PASS scp /home/scripts/copy_kass_south/new/POSTSTOP.PRG root@$ip:/home/1/.dosemu/drives/c/SOUTH.TML/POSTSTOP.PRG
